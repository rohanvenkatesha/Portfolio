...
const Experience = () => {
  ...
  return (
    <section
      className="montserrat-reg w-full h-auto flex flex-col items-center justify-center relative gap-10 py-20 text-white mx-auto"
      id="timeline"
    >
      <StarryBackground />
      <motion.div
        ...
        className="mb-6"
      >
        <h1 className="montserrat-hero text-[40px] font-semibold cursor-pointer bg-gradient-right py-10">Timeline</h1>
      </motion.div>
      ...
      {activeTab === "Experience" && (
        <div className="w-full max-w-4xl mb-8">
          ...
          <motion.div
             className="relative w-[90%] sm:w-[80%] md:w-[70%] mb-4 h-6 bg-transparent justify-center rounded-full mx-auto"
            style={{
          ...
          <div className="relative flex w-[90%] gap-5 sm:w-[80%] md:w-[70%] mb-4 h-6 justify-center mx-auto">
        <div className="flex items-center gap-2">
          <div className="w-5 h-5 bg-[#4e73df] rounded-lg"></div>
          <span className="text-white text-sm">{fullTimeYears} years Full-time</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-5 h-5 bg-[#fbbd02] rounded-lg"></div>
          <span className="text-white text-sm">{internshipYears} years Internship</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-5 h-5 bg-[#9b59b6] rounded-lg"></div>
          <span className="text-white text-sm">{partTimeYears} years Part-time</span>
        </div>
      </div>
        </div>
      )}
      ...
      <div className="w-full max-w-4xl">
        {timelineData[activeTab].map((item, index) => (
          <motion.div
            key={index}
            className="flex flex-row gap-6 mb-8 p-6 border-l-4 border-gray-300 rounded-lg shadow-lg bg-gradient-to-r from-gray-900 to-gray-1000"
            initial={{ opacity: 0, y: 50 }}
